...
TEACHER_ADAPTER="${PROJECT_ROOT}/results/llama3/teacher_lora"
RUN_ID="$(date +%Y%m%d_%H%M%S)"
LOG_DIR="${LLAMA3_LOG_DIR:-${PROJECT_ROOT}/results/llama3/run_all_logs/${RUN_ID}}"
...
if bash scripts/train.sh configs/distillation/teacher_lora_llama3.yaml "$@" 2>&1 | tee "${LOG_DIR}/teacher_lora_llama3.log"; then
